...
function TrustSignalCard({ signal }: { signal: TrustSignal }) {
  ...
  const count = useCountUp(signal.value, 2000, isVisible)
  ...
  return (
    <div
      ref={cardRef}
      className="flex flex-col items-center text-center p-6 rounded-lg bg-white shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
    >
