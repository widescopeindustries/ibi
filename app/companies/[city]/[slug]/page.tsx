...
export async function generateMetadata({ params }: RepProfilePageProps): Promise<Metadata> {
    ...
    // Parse city from slug (e.g., "dallas" from URL)
...
export default async function RepProfilePage({ params }: RepProfilePageProps) {
    ...
    const breadcrumbItems = [
        ...
        { name: 'Companies', url: `${defaultSEO.siteUrl}/companies` },
        { name: profile.city || 'Location', url: `${defaultSEO.siteUrl}/companies/${params.city}` },
        { name: fullName, url: `${defaultSEO.siteUrl}/companies/${params.city}/${params.slug}` },
    ]
            ...
            <div className="min-h-screen bg-gray-50 py-12">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white rounded-lg shadow p-6">
                        ...
                        {/* Submit Review Form */}
                        <SubmitReviewForm repId={profile.id} />
                    </div>
                </div>
            </div>
        </>
